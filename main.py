...
BLACKLIST = [
    ...
    "system: you are","system: ignore","system: your new instructions",
    "system: from now on","system: disregard","system: forget",
    "<system>","</system>","[system]","[/system]",
    "###system","# system","##system",
    "assistant: i will","assistant: sure, i'll ignore",
    # Fake completion signals
    "human: ignore","user: ignore","### instruction",
    "### human","### assistant","<|im_start|>","<|im_end|>",
    "<|system|>","<|user|>","<|assistant|>",
    "[inst]","[/inst]","<<sys>>","<</sys>>","your new instructions are","give me the account",
